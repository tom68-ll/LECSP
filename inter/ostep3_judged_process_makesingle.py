...
if args.order == 0:
    input_path1 = "../data/inter_data/step2_out"
    input_path2 = "../data/inter_data/step1_out"
    output_path = '../data/inter_data/step3_out'
...
if __name__ == '__main__':
    ...
    for task_now in range(4,7):
        ...
        for correction in tqdm(corrections):
            if correction['result'].startswith(' Yes'):
                output_tmp.append({
            ...
            elif correction['result'].startswith(' No'):
